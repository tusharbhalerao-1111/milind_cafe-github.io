...
$totalMenuItems = $conn->query("SELECT COUNT(*) as count FROM menu")->fetch_assoc()['count'] ?? 0;
$pendingOrders = $conn->query("SELECT COUNT(*) as count FROM orders WHERE status = 'Pending'")->fetch_assoc()['count'] ?? 0;
$recentOrders = $conn->query("SELECT * FROM orders ORDER BY id DESC LIMIT 10");
?>
...
<head>
    ...
    <title>Admin Dashboard - Milind Cafe</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 sidebar">
                ...
                <p class="text-muted small">Welcome, <?php echo $admin_username; ?></p>
            ...
            <div class="col-md-10 content">
                ...
                <div class="row mt-4">
                    <div class="col-md-3">
                        <div class="stat-card">
                            <h3><i class="fas fa-shopping-cart"></i> <?php echo $totalOrders; ?></h3>
                            <p>Total Orders</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stat-card" style="background: linear-gradient(135deg, #f093fb, #f5576c);">
                            <h3><i class="fas fa-rupee-sign"></i> ₹<?php echo number_format($totalRevenue, 0); ?></h3>
                            <p>Total Revenue</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stat-card" style="background: linear-gradient(135deg, #4facfe, #00f2fe);">
                            <h3><i class="fas fa-utensils"></i> <?php echo $totalMenuItems; ?></h3>
                            <p>Menu Items</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stat-card" style="background: linear-gradient(135deg, #fa709a, #fee140);">
                            <h3><i class="fas fa-clock"></i> <?php echo $pendingOrders; ?></h3>
                            <p>Pending Orders</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="orders.php?delete=<?php echo $order['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this order?')">
                                ...
                                <?php 
                                    ...
                                    echo '<tr><td colspan="8" class="text-center">No orders yet.</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
